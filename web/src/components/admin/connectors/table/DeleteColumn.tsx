  ...
  return (
    ...
    >
      {connectorIndexingStatus.is_deletable ? (
        ...
        <div>
          {deleteHovered && (
            <div className="w-64 z-30 whitespace-normal flex absolute mt-8 top-0 left-0 bg-background dark:bg-background-dark border border-border dark:border-border-dark px-3 py-2 rounded shadow-lg text-xs">
