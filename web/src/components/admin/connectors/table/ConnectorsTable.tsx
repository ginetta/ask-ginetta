  ...
  return (
    <div className="flex">
      ...
      {shouldDisplayDisabledToggle && (
        ...
        >
          {statusHovered && (
            <div className="flex flex-nowrap absolute top-0 left-0 ml-8 bg-background dark:bg-background-dark border border-border dark:border-border-dark px-3 py-2 rounded shadow-lg">
