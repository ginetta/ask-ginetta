...
function SectionHeader({
  ...
  return (
    <div className="text-lg text-emphasis dark:text-emphasis-dark font-medium flex pb-0.5 mb-3.5 mt-2 font-bold">
  ...
  return (
    ...
    >
      ...
      <div className="h-4/6 flex flex-col mt-4">
        <div className="px-3 mb-3 flex border-b border-border dark:border-border-dark">
          <SectionHeader
            name={
                  ...
                  <div
                    ...
                    className={
                      ind === dedupedDocuments.length - 1
                        ? "mb-5"
                        : "border-b border-border-light dark:border-border-light-dark mb-3"
                    }
                  >
                    <ChatDocumentDisplay
                      document={document}
      ...
      <div className="text-sm mb-4 border-t border-border dark:border-border-dark pt-4 overflow-y-hidden flex flex-col">
        <div className="flex border-b border-border dark:border-border-dark px-3">
          <div className="flex">
